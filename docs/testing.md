...
the SDK and no PowerShell reads `1838 passed, 13 skipped`, and a checkout set up
with `requirements-dev.txt` alone reads `1765 passed, 86 skipped` rather than 73
