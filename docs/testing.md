...
the SDK and no PowerShell reads `1994 passed, 13 skipped`, and a checkout set up
with `requirements-dev.txt` alone reads `1921 passed, 86 skipped` rather than 73
