...
the SDK and no PowerShell reads `2084 passed, 13 skipped`, and a checkout set up
with `requirements-dev.txt` alone reads `2011 passed, 86 skipped` rather than 73
