...
the SDK and no PowerShell reads `2083 passed, 13 skipped`, and a checkout set up
with `requirements-dev.txt` alone reads `2010 passed, 86 skipped` rather than 73
