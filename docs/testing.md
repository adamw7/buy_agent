...
2668 Python tests and 269 UI tests. Nothing in either suite touches the network
...
the SDK and no PowerShell reads `2648 passed, 20 skipped`, and a checkout set up
with `requirements-dev.txt` alone reads `2574 passed, 94 skipped` rather than 74
