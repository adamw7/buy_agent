...
2113 Python tests and 200 UI tests. Nothing in either suite touches the network
...
the SDK and no PowerShell reads `2086 passed, 13 skipped`, and a checkout set up
with `requirements-dev.txt` alone reads `2013 passed, 86 skipped` rather than 73
