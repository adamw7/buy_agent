...
| [0020](0020-test-on-windows-as-well-as-linux.md) | Run both suites on Windows as well as Linux | Superseded by [ADR-0037](0037-run-windows-weekly-rather-than-on-every-push.md) |
